...
#### 1.5.1 누락된 UI 모듈
**위치**: [main.py:8-16](main.py#L8)

누락된 파일:
```
ui/
├── ui_login.py          # Ui_login_windows
├── ui_main.py           # Ui_MainWindow
├── utils_ai_setting_window.py
├── utils_schedule_window.py
├── utils_object_setting_window.py
├── utils_search_window.py
├── utils_labeling_window.py
└── utils_server_setting_window.py
```

**문제점**:
- 프로젝트 실행 불가
- Qt Designer `.ui` 파일이 Python 코드로 변환되지 않음
